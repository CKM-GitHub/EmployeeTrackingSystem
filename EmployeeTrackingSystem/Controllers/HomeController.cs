...
namespace EmployeeTrackingSystem.Controllers
{
    public class HomeController : Controller
    {
        ...
        {            
            ...
            string json2 = Get_DashboardInformation(8, "D02");
            ...
            string json7 = Get_DashboardInformation(8, "D07");
